...
function autoloader( $resource = '' ) {
	$resource_path  = false;
	$namespace_root = 'wordpress_theme\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( wordpress_theme ), $directory, $file_name );
...
spl_autoload_register( '\wordpress_theme\Inc\Helpers\autoloader' );